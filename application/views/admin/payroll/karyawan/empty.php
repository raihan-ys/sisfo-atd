              ...
              <tr>
                <td class="mhs-tb-header" colspan="10">
                  ...
                  <div class="mhs-tb-title" align="center">
                    <a class="text-white" title="Go back, if the data you're searches with keyword is not found." href="<?= site_url('admin/payroll/karyawan') ?>">
            ...
            <tbody>
              <tr>
                <td style="background-color: oldlace">
                  ...
                  <h5 align="center">
                    <a class="text-info" href="<?= site_url('admin/payroll/karyawan/add') ?>">Tambah data</a>
