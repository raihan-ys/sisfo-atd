                ...
                <td class="mhs-tb-header" colspan="10">
                  ...
                  <div class="mhs-tb-title" align="center">
                    <a class="text-white" title="Go back, if the data you're searches with keyword is not found." href="<?= site_url('admin/payroll/jabatan') ?>">
                      <i class="far fa-circle fas fa-users"></i> Daftar Penggajian
                    </a>
                  </div>
                  ...
                  <!-- flashdata -->
                    ...
                    <?php elseif ($this->session->flashdata('gaji_truncated')) : ?>
                    <div class="alert alert-dismissible fade show bg-lime" id="alertDiv" style="width: 500px">
                      <h4><?= $this->session->flashdata('gaji_truncated') ?> <i class="fas fa-fire"></i></h4>
                      <?php $this->session->unset_userdata('gaji_truncated') ?>
                      <button type="button" class="close" id="closeAlert" aria-label="close">
                        <span aria-hidden="true">&times;</span>
                      </button>
                    </div>
                    ...
                    <form method="GET">
                      ...
                      <!-- input keyword -->
                      <label for="keyword">Pencarian Data Gaji: </label>
                      <input class="input" style="width: 230px" title="Enter the keyword" type="search" name="keyword" placeholder="Masukkan Kode Gaji" value="<?= html_escape($keyword) ?>">&nbsp&nbsp
            ...
            <tbody>
              <tr>
                <td style="background-color: oldlace">
                  ...
                  <h5 align="center">
                    <a class="text-info" href="<?= site_url('admin/payroll/gaji/add') ?>">Tambah data</a>
